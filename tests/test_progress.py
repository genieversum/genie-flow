...
def test_on_success(session_manager_unconnected, monkeypatch):
    session_id = str(ulid.new().uuid)
    invocation_id = "some-task-" + ulid.new().str
...
def test_on_failure(session_manager_unconnected, monkeypatch):
    session_id = str(ulid.new().uuid)
    invocation_id = "some-task-" + ulid.new().str
