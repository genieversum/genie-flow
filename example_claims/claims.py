...
class ClaimsMachine(GenieStateMachine):
    ...
    templates: dict[str, Union[str, Template, dict[str]]] = dict(
        user_entering_role="instruction_opening",
        ai_extracts_user_role="prompt_extract_user_role",
        user_entering_role_retry="feedback_cannot_extract_role",
        user_entering_initial_information="instruction_initial_information",
        ai_extracts_information="prompt_extract_information",
        user_enters_additional_information="feedback_need_more_information",
        user_views_start_of_generation="feedback_start_generation",
        ai_extracts_categories="prompt_extract_categories",
        user_views_categories="feedback_view_categories",
        ai_conducts_research=dict(
            ingredients="prompt_research_ingredients",
            benefits="prompt_research_benefits",
            sensory="prompt_research_sensory",
            marketing="prompt_research_marketing",
        ),
        ai_conducts_research_with_packaging=dict(
            ...
            sensory="prompt_research_sensory",
            marketing="prompt_research_marketing",
            packaging="prompt_research_packaging",
        ),
        user_views_research="feedback_views_research",
        ai_generates_claims="prompt_generate_claims",
        user_views_claims="feedback_views_claims",
    )
